...
import MainSliderImageOpts from '../../models/MainSliderImageOpts';

const AddSlideModal = ({ title, onSubmit, slide, handleClose }) => {
    const i18n = Hooks.useI18n();
    const [slideToSubmit, setSlideToSubmit] = useState(slide);
        ...
        ajaxPOST({
			...
			success: response => {
				if (response.success && response.message == "OK") {
                    ...
                    setSlideToSubmit({...slideToSubmit, 
                        photo: logo,
                    })
                } else {
		...
		<Fragment>
            ...
            <div className="mx-6 my-4">
                <div className="flex flex-col lg:col-span-2 xs:col-span-6">
                    ...
                    ) : slideToSubmit?.photo?.url ? (
                        <div className="text-center md:text-left">
                            <div className="py-4 mb-4">{'Trenutna slika:'}
                                <img className="mt-4" src={slideToSubmit?.photo?.url} className="inline-block" />
                            </div>
                        </div>
                    ) : null}
                ...
                <div className="flex flex-col">
                    ...
                    <TextField
                        ...
                        onChange={e => setSlideToSubmit({...slideToSubmit, 
